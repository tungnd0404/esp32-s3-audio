...
#define VS1053_XCS_PIN      GPIO_NUM_14     /* Chip select cho lệnh SCI (XCS) */
#define VS1053_XDCS_PIN     GPIO_NUM_15    /* Chip select cho dữ liệu SDI (XDCS) */
#define VS1053_DREQ_PIN     GPIO_NUM_16    /* Data request - chip kéo cao khi sẵn sàng nhận lệnh/data */
#define VS1053_RESET_PIN    GPIO_NUM_17    /* Reset phần cứng, tích cực mức thấp */
